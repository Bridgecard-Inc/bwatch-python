...
class BWatchAsgiMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next):
        ...
        create_transaction(
            session.body, mapping=bwatch_python_data_context.transactions_data_mappers
        )
                ...
                if usecase_rules:
                    ...
                    for rule in usecase_rules:
                        ...
                        if rule_key_list[0] == "transactions":
                            ...
                            if (
                                rule.parameter
                                == RuleParameterEnum.DATA_COMPARISON_EQUAL_TO
                            ):
                                ...
                                rule.parameter
                                == RuleParameterEnum.DATA_MATCH_GREATER_THAN
                            ):
                                ...
                                rule.parameter == RuleParameterEnum.DATA_MATCH_LESS_THAN
                            ):
